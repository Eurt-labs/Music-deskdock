...
### Step 2: Start the Python Script
Run the transmitter script on your PC:
```powershell
python audio_sender.py
```
*(Press Enter when prompted for the IP address to let Auto-Discovery connect automatically)*

### Step 3: Check the Logs
Open [`music_deskdock.log`](file:///c:/Users/Dhruv%20Saraswat/Downloads/Music-deskdock/music_deskdock.log) in any text editor or IDE to view all telemetry tokens, connection events, and diagnostic logs in real time.
